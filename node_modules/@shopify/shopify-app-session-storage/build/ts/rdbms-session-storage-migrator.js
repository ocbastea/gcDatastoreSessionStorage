...
var RdbmsSessionStorageMigrator = /** @class */ (function (_super) {
    ...
    function RdbmsSessionStorageMigrator(dbConnection, opts) {
        if (opts === void 0) { opts = {}; }
        return _super.call(this, dbConnection, tslib_1.__assign(tslib_1.__assign({}, types_1.defaultRdbmsSessionStorageMigratorOptions), opts)) || this;
    }
